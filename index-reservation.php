    ...
    <div class="container h-100">
        <div class="mt-5">
            <div class="row">
                ...
                <div class="col-8">
                <div class="card">
                <h1 class="text-center text-primary"><b><u>Formulaire De Reservation</u></b></h1>
                
                <div class="row">
                <div class="col-3 pl-5"><label for="nom">Date De Reservation:</label></div>
                <div class="col-9 pr-5"> <input id="nom" class="form-control" type="text" placeholder="nom client"></div>
                </div>
                <br>
                <div class="row">
                <div class="col-3 pl-5"><label for="prenom">Duree De Reservation:</label></div>
                <div class="col-9 pr-5"><input id="prenom" class="form-control" type="text" placeholder="prenom client"></div>
                </div>
                <br>
                <div class="row">
                <div class="col-3 pl-5"><label for="email">Nombre:</label></div>
                <div class="col-9 pr-5"><input id="email" class="form-control" type="email" placeholder="Email client"></div>
                </div>
                <br>
                <div class="row">
                <div class="col-3 pl-5"><label for="spam">Nom Du Client:</label></div>
                <div class="col-9 pr-5"><input id="spam" class="form-control" type="tel" placeholder=" Numero telephone"></div>
                </div>
                <br>
                <div class="row">
                <div class="col-3 pl-5"><label for="national">Destination:</label></div>
